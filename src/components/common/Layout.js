        ...
        <>
            ...
            <div className="viewport">
                ...
                <div className="viewport-top">
                    ...
                    <header className={"site-head " + (isHome ? 'home' : '')}>
                                    ...
                                    {isHome ? null :
                                        <nav className="site-nav">
                                            <div className="site-nav-left">
                                                <Link to="/">
                                                    {config.logo ?
                                                        <img className="site-logo not-home" src={config.logo} alt={config.siteTitleMeta} />
                    ...
                    <footer className="site-foot">
                        <div className="site-foot-nav container">
                            <div className="site-foot-nav-left">
                                © <Link to="/">{config.siteTitleMeta}</Link> - <a href="https://cv.tatviquyen.name.vn" target="_blank">My CV ↗</a>
                            </div>
